    ...
    <div className="max-w-[1000px] mx-auto px-4 relative z-10 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
        ...
        <a
          ...
          className="flex items-center gap-2 bg-transparent text-white border-2 border-white px-8 py-4 rounded-full font-bold uppercase tracking-wider hover:bg-white hover:text-cusc-blue transition-all hover:scale-105"
        >
          <Mail size={20} />
          Gửi yêu cầu
        </a>
    ...
    <div className="max-w-[1200px] mx-auto px-4 flex flex-col items-center justify-center gap-1 text-center">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-6 text-xs sm:text-sm text-blue-100">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span>Email: <a href="mailto:cusc.sales@ctu.edu.vn" className="text-white font-medium hover:text-cusc-gold transition-colors">cusc.sales@ctu.edu.vn</a></span>
        </div>
        <div className="flex items-center gap-1.5">
          <Globe size={14} className="text-blue-200 shrink-0" />
